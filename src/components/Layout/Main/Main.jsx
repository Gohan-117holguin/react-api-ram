...
import logo from '../../../assests/img/rick_logo.jpg'
import { Span } from '../../UI/Span/Span'

export const Main = () => {

    // const pStatus = document.getElementById('parrafo1')
    // const pGender = document.getElementById('parrafo2')
            ...
            <main>
                <section className='section__input'>
                    <div className='container__label'>
                        <Imagen src={logo} clase='img__input' />
                        <label>Search</label>
                    </div>
